"! @testing BDEF:ZRAP100_R_TravelTP_GS1
CLASS zrap100_tc_travel_eml_gs1 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC
  FOR TESTING
...
CLASS zrap100_tc_travel_eml_gs1 IMPLEMENTATION.
  METHOD class_setup.
    ...
    cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
                      i_for_entities = VALUE #(
                        ( i_for_entity = 'ZRAP100_R_TravelTP_GS1' ) ) ).
  ...
  METHOD create_with_action.
    ...
    MODIFY ENTITIES OF ZRAP100_R_TravelTP_GS1
     ENTITY Travel
    ...
    SELECT * FROM ZRAP100_R_TravelTP_GS1 INTO TABLE @DATA(lt_travel). "#EC CI_NOWHERE
