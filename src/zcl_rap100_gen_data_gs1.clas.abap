CLASS zcl_rap100_gen_data_gs1 DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_RAP100_GEN_DATA_GS1 IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'gs1',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atravgs1.
*    DELETE FROM zrap100_dtravgs1.

    "insert travel demo data
    INSERT zrap100_atravgs1  FROM (
        SELECT
